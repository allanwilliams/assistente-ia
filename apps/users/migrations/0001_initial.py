    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(blank=True, max_length=500, null=True, unique=True, verbose_name='CPF')),
                ...
                ('fusionauth_user_id', models.CharField(blank=True, max_length=50, null=True, verbose_name='FusionAuth user ID')),
                ...
                ('numero', models.CharField(blank=True, max_length=11, null=True, verbose_name='Número')),
                ...
                ('escolaridade', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='user_escolaridade', to='contrib.escolaridades')),
                ('estado', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_usuarioestado', to='contrib.estados')),
                ('estado_civil', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='user_estado_civil', to='contrib.estadoscivis')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('municipio', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='user_municipios', to='contrib.municipios')),
                ('nacionalidade', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='user_nacionalidade', to='contrib.nacionalidades')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criado_em', models.DateTimeField(blank=True, null=True)),
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('preferencia', models.IntegerField(choices=[(1, 'Menu fixo')], verbose_name='Preferência')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=128, verbose_name='password')),
                ('usuario', models.CharField(max_length=128, null=True, verbose_name='password')),
